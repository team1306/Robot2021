...
public class TankDrive extends SubsystemBase {
  ...
  public TankDrive() {
    ...
    rightFollower1 = new CANSparkMax(Constants.K_DRIVE_RIGHT_BACK_ID, MotorType.kBrushless);
    ...
    leftFollower1 = new CANSparkMax(Constants.K_DRIVE_LEFT_BACK_ID, MotorType.kBrushless);
    ...
    // get encoders
    rightEnc = rightLeader.getEncoder(EncoderType.kHallSensor, 4096);
    leftEnc = leftLeader.getEncoder(EncoderType.kHallSensor, 4096);
  ...
  public boolean isShiftLow(){
    return true;//shift.get().equals(K_LOW_GEAR);
  }
