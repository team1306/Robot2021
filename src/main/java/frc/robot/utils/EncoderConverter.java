...
/**
 * A class for storing the encoder constants and mathematics around translating encoder values into
 * physical values.
 * 
 * Encoders cannot be constructed except in this class, and it is important to check your imports to
 * make sure you are not interfering with an edu.wpi.first.wpilibj.Encoder.
 * 
 * Most wpilibj encoder use cases look for velocity over 100ms, and this is reflected here.
 */
public class EncoderConverter {
	public static final EncoderConverter Grayhill256 = new EncoderConverter(
		4 * 256
	);
	public static final EncoderConverter VersaPlanetary = new EncoderConverter(
		4 * 1024
	);
	public static final EncoderConverter NeoInternal = new EncoderConverter(
		42 * 4
	);
